...
<body>
    <div class="container">
        ...
        <p>{{ __('ご登録ありがとうございます。以下のボタンをクリックして、メールアドレスの確認を完了してください。') }}</p>
        
        <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
                <td align="center">
                    <a href="{{ $actionUrl }}" class="btn btn-primary" target="_blank" rel="noopener">{{ $actionText }}</a>
                </td>
            </tr>
        </table>
        
        <p>{{ __('このボタンの有効期限は :count 分です。', ['count' => config('auth.verification.expire', 60)]) }}</p>
        
        <p>{{ __('もしこのメールに心当たりがない場合は、このまま破棄してください。') }}</p>
